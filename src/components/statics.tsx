...
export const CompanyStatics = () => {
  return (
    <section className='relative py-8 md:py-10 bg-gradient-to-r from-[#000099] via-[#5a5acc] to-[#cc33ff]'>
      ...
      <section className='relative z-10'> <h2 className="text-white text-center text-2xl font-semibold tracking-tight  sm:text-3xl">Our Remarkable Achievements to Share</h2>
        <p className="text-center text-white">we take pride in showcasing our accomplishments that reflect our growth and success.<br /> Explore the highlights of our journey and the impact we’ve made so far! </p>
